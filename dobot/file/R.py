...
from dobot.functional import SingleClass, async_absolute_path, absolute_path
...
class R:
    ...
    _monitor: BaseFileMonitor
    _file: File

    def __init__(self):
        self._monitor: BaseFileMonitor = WindowsFileMonitor() if self._get_platform() == WINDOWS else None
        self._file = File()
